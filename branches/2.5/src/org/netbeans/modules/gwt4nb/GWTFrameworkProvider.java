    ...
    private class EnableGWTAction implements AtomicAction {
        ...
        public void run() throws IOException {
            ...
            if (libUser != null) {
                ...
                /*
                 This could be used to resolve
                 https://gwt4nb.dev.java.net/issues/show_bug.cgi?id=53
                 But doen't work because GWT4NB is not a friend module of
                 web.project
                 WebProjectLibrariesModifier wplm =
                        (WebProjectLibrariesModifier) project.getLookup().lookup(
                        WebProjectLibrariesModifier.class);
                wplm.addCompileLibraries(new Library[] {libUser});
                 */
