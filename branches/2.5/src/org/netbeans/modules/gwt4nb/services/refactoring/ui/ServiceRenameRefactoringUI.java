...
import org.netbeans.modules.gwt4nb.services.refactoring.ui.*;
...
/** Refactoring UI object for Service Rename refactoring.
 *
 * @author Martin Matula
 */
public class ServiceRenameRefactoringUI implements RefactoringUI {
    // reference to Service rename refactoring this UI object corresponds to
    ...
    private ServiceRenamePanel panel;

    private String description;
    
    /** Creates a new instance of ServiceRenameRefactoringUI
     * @param selectedElements Elements the refactoring action was invoked on.
     */
    public ServiceRenameRefactoringUI(TreePathHandle[] selectedElements, CompilationInfo info) {
        TypeElement clazz = (TypeElement)info.getTrees().getElement(selectedElements[0].resolve(info));
       ...
       // create an instance of Service Rename refactoring object
        ...
        refactoring = new ServiceRenameRefactoring(Lookups.singleton(sourceType));
    ...
    public CustomRefactoringPanel getPanel(ChangeListener parent) {
        if (panel == null) {
            panel = new ServiceRenamePanel(refactoring, serviceClassSet, parent);
        }
        return panel;
    }
    ...
    public String getDescription() {
        return NbBundle.getMessage(ServiceRenameAction.class, "DSC_ServiceRename", description); // NOI18N
    }

    public String getName() {
        return NbBundle.getMessage(ServiceRenameAction.class, "LBL_ServiceRename"); // NOI18N
    }
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx(ServiceRenameRefactoringUI.class.getName());
    }
    ...
    private void captureParameters() {
        ...
        refactoring.setNewServiceName(panel.getNewServiceName());
    }
