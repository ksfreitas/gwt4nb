...
/** Service Rename Refactoring implementation class.
 *
 * @author Prem
 */
public final class ServiceRenameRefactoring extends AbstractRefactoring {
    ...
    public ServiceRenameRefactoring(Lookup sourceType) {
        super(sourceType);
    }
