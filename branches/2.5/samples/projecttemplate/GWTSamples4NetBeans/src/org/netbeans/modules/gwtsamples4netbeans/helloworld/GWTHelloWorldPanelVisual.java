...
public class GWTHelloWorldPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";

    private GWTHelloWorldWizardPanel panel;

    public GWTHelloWorldPanelVisual(GWTHelloWorldWizardPanel panel) {
        initComponents();
        this.panel = panel;
