...
public class GWTSortableTablePanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";

    private GWTSortableTableWizardPanel panel;

    public GWTSortableTablePanelVisual(GWTSortableTableWizardPanel panel) {
        initComponents();
        this.panel = panel;
