...
public class GWTDynamicListPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";

    private GWTDynamicListWizardPanel panel;

    public GWTDynamicListPanelVisual(GWTDynamicListWizardPanel panel) {
        initComponents();
        this.panel = panel;
