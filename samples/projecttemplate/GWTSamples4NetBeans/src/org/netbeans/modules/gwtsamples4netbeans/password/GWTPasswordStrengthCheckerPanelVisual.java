...
public class GWTPasswordStrengthCheckerPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";

    private GWTPasswordStrengthCheckerWizardPanel panel;

    public GWTPasswordStrengthCheckerPanelVisual(GWTPasswordStrengthCheckerWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    void read(WizardDescriptor settings) {
        ...
        if (projectName == null) {
            projectName = "GWTPasswordStrengthChecker";
        }
