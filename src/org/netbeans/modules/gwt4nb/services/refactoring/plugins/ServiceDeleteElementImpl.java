...
class ServiceDeleteElementImpl extends SimpleRefactoringElementImplementation {
    ...
    private static final String USAGE_EXAMPLE = "UsageExample"; // NOI18N
    ...
    public String getText() {
        return NbBundle.getMessage(ServiceDeleteElementImpl.class, 
                "DelSvc", // NOI18N
    ...
    private static class ServiceDeleteTask implements Runnable, CancellableTask<CompilationController>  {
        ...
        public void run(CompilationController info) throws Exception {
            ...
            if(usageExample != null){
                SourceUtils.getFile(ElementHandle.create(usageExample),
                        info.getClasspathInfo()).delete();
            }
