 ...
 * @author Prem
 */
public final class ServiceRenameRefactoringPlugin extends
        ProgressProviderAdapter implements RefactoringPlugin {
    ...
    public Problem prepare(RefactoringElementsBag refactoringElements) {
        refactoringElements.addFileChange(refactoring,
                new ServiceRenameElementImpl(refactoring, refactoringElements));
        return null;
    }
